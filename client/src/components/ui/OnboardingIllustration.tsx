...
// Asset path pattern: /assets/onboarding/step{index}.svg
...
function Step0Illo() {
  return (
    <svg viewBox="0 0 240 260" className="w-full h-full" fill="none">
      ...
      {/* Arrow from parent to box */}
      <path d="M86 130 Q96 145 105 148" stroke="url(#pGrad)" strokeWidth="2" fill="none" strokeDasharray="3 3" />
      {/* Arrow from child to box */}
      <path d="M144 130 Q134 145 125 148" stroke="url(#pGrad2)" strokeWidth="2" fill="none" strokeDasharray="3 3" />

      <defs>
        <linearGradient id="pGrad" x1="0" y1="0" x2="1" y2="0"><stop stopColor="#a855f7" /><stop offset="1" stopColor="#ec4899" /></linearGradient>
        <linearGradient id="pGrad2" x1="0" y1="0" x2="1" y2="0"><stop stopColor="#ec4899" /><stop offset="1" stopColor="#a855f7" /></linearGradient>
      </defs>
    </svg>
  );
}
...
function Step1Illo() {
  return (
    <svg viewBox="0 0 240 260" className="w-full h-full" fill="none">
      ...
      {/* Photo being taken — toy block on screen */}
      ...
      {/* Camera icon overlay (top right of phone screen) */}
