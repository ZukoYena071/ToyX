        ...
        <div className="mb-5">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <button hidden
              ...
              className="min-w-[44px] min-h-[44px] bg-black dark:bg-gray-800 rounded-xl flex items-center justify-center hover:bg-gray-800 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <button hidden
              ...
              className="min-w-[44px] min-h-[44px] bg-blue-600 rounded-xl flex items-center justify-center hover:bg-blue-700 transition-colors"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="white">
