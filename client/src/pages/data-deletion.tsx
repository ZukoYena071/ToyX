...
import { DATA_DELETION_HTML, LAST_UPDATED } from "@/content/data-deletion";
    ...
    <PageContainer className="pb-24">
      <div className="sticky top-0 z-50 bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-lg mx-auto flex items-center justify-between px-4 py-3">
          <h1 className="text-lg font-bold text-gray-900 dark:text-gray-50">Data Deletion Instructions</h1>
      ...
      <div className="max-w-lg mx-auto px-4 py-4 space-y-4">
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: DATA_DELETION_HTML }}
        />
      </div>
