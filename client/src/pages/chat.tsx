...
export default function Chat() {
  ...
  return (
    <PageContainer className="pb-24 flex flex-col">
      <div className="sticky top-0 z-50 bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-800">
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/chat">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-purple-600 dark:text-purple-400">{exchange.toy.name}</p>
              </div>
            </div>
          </div>
          <button className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors min-h-[44px] min-w-[44px]">
      ...
      <div className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
        <div className="px-4 py-4">
                ...
                if (userConfirmed) {
                  return (
                    <div className="flex justify-center">
                      <div className="text-sm text-gray-500 dark:text-gray-400 bg-blue-50 dark:bg-blue-900/20 px-4 py-2 rounded-2xl border border-blue-200 dark:border-blue-700">
          ...
          {exchange?.status === "completed" && canReviewData?.canReview === true && (
            <div className="flex justify-center">
              <Button onClick={() => setShowReviewForm(true)} className="bg-amber-500 hover:bg-amber-600 text-white rounded-2xl px-6">
          ...
          {exchange?.status === "completed" && canReviewData?.canReview === false && (
            <div className="flex justify-center">
              <div className="text-sm text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-2xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-2xl px-4 py-3 text-sm text-gray-900 dark:text-gray-50 placeholder:text-gray-400 dark:placeholder:text-gray-500 border-none focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-white dark:focus:bg-gray-900 transition-all min-h-[44px]"
              />
              <button
                onClick={handleSendMessage}
                disabled={!message.trim() || sendMessageMutation.isPending}
                className="w-10 h-10 bg-purple-500 hover:bg-purple-600 rounded-full flex items-center justify-center transition-colors disabled:opacity-50 min-h-[44px] min-w-[44px]"
              >
